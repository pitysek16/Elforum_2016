var s = document.getElementsByClassName('timer-span');
var oneDay = 24 * 60 * 60 * 1000;
var firstDate = new Date("December 15, 2016 10:00:00");var secondDate = new Date();
...
}}}if(s[0].innerHTML <= -1) {clearInterval(i);document.getElementsByClassName('timer')[0].innerHTML='<h2>Скидка закончилась</h2>'}}